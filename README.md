...
[![Resume](https://img.shields.io/badge/Resume-Google_Drive_PDF-10b981?style=for-the-badge&logo=googledrive&logoColor=white)](https://drive.google.com/file/d/1UpLzfXySojcTQjQaO0kVaDY60572pRMn/view)
...
- **Resume**: [Google Drive Resume](https://drive.google.com/file/d/1UpLzfXySojcTQjQaO0kVaDY60572pRMn/view)
...
- **Key Features**:
  - Secure user registration and login with JWT authentication & Spring Security.
...
- **Key Features**:
  - Secure user registration and login using JWT Authentication & Spring Security.
...
- **Key Features**:
  ...
  - Python Machine Learning classification model predicting safety & quality scores.
  - Flask / Spring Boot REST API receiving live IoT sensor payload streams into MySQL database.
  - Interactive dashboard displaying continuous parameter trends and predictive insights.
- **Technologies Used**:
  - **Machine Learning**: Python, Scikit-Learn, Classification Models
  - **IoT & Hardware**: ESP32 Microcontroller, pH Sensor, Turbidity Sensor
  - **Backend & DB**: Flask, Spring Boot, RESTful APIs, MySQL
...
| Layer | Technology |
| :--- | :--- |
| **Markup & Layout** | HTML5 (Semantic Structure, Accessible ARIA Labels) |
| **Styling** | Vanilla CSS3 (Custom CSS Variables, Glassmorphism, CSS Grid, Flexbox, Keyframe Animations) |
| **Logic & Scripting** | Vanilla JavaScript (ES6+, DOM Manipulation, Event Handling, Canvas API, LocalStorage) |
| **Typography** | `Outfit` (Headings), `Inter` (Body Text), `JetBrains Mono` (Code & Badges) |
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/Ganesh40292/portfolio.git
   cd portfolio
   ```
...
This repository includes a [`vercel.json`](vercel.json) file configured for 1-click deployment to Vercel.
...
1. Push code to GitHub:
   ...
   ```
2. Go to **[vercel.com](https://vercel.com)** ➔ Import repository `portfolio` ➔ Click **Deploy**.
3. Live production link generated automatically!
